// PROTOTYPE (issue #3): build the test tracks and their reference elevation. Throwaway.
//
...
const TRACKS = [
  ["lyon-road-10", "road", [4.832, 45.7578], 10, 90, { SAC_scale_limit: 2, path_preference: 0 }],
  ["lyon-fourviere-10", "road", [4.832, 45.7578], 10, 270, { SAC_scale_limit: 2, path_preference: 0 }],
  ["chaponost-road-20", "road", [4.743, 45.71], 20, 180, { SAC_scale_limit: 2, path_preference: 0 }],
  ["chaponost-trail-10", "trail", [4.743, 45.71], 10, 270, { SAC_scale_limit: 3, path_preference: 20 }],
  ["chamonix-mixed-10", "mixed", [6.8694, 45.9237], 10, 36, { SAC_scale_limit: 2, path_preference: 0 }],
  ["chamonix-trail-5", "trail", [6.8694, 45.9237], 5, 144, { SAC_scale_limit: 3, path_preference: 20 }],
  ["chamonix-trail-10", "trail", [6.8694, 45.9237], 10, 324, { SAC_scale_limit: 3, path_preference: 20 }],
  ["annecy-trail-20", "trail", [6.1296, 45.8992], 20, 180, { SAC_scale_limit: 3, path_preference: 20 }],
];
